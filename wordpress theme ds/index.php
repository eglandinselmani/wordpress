...
<div class="box-border-image">this box is with image </div>
<div class="box-ellipse">elligtical border radius</div>
<div class="bg-example">this is a background with image and gradient </div>
